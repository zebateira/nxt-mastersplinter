	...
	private class StartBot extends AsyncTask<Void, Void, Integer> {
		...
		protected Integer doInBackground(Void... params) {
			...
			if(CameraVariables.cameraVariables.getValX() == -1)
				return -1;
			if(CameraVariables.cameraVariables.getValX() != 0 && CameraVariables.cameraVariables.getValX() < (Variables.MEDIUM_VALUE-Variables.THRESHOLD_COLOR)){ // Linha à esquerda
				return Variables.MORE_SPEED_LEFT;
			}
			else if(CameraVariables.cameraVariables.getValX() != 0 && CameraVariables.cameraVariables.getValX() > (Variables.MEDIUM_VALUE+Variables.THRESHOLD_COLOR)){ // Linha à direita
